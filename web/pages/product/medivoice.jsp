  ...
  <div id="boxes">
    ...
    <div class ="other-content">
      <div class="main-text">
        ...
        <img src="${pageContext.request.contextPath}/images/medivoice2.png" alt="Medivoice Android app" width="200px"/>
        ...
        <img src="${pageContext.request.contextPath}/images/medivoice3-personal-care.png" alt="Medivoice Android app" width="200px"/>
