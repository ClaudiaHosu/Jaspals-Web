...
<section class="hero homepage">
  <div class="container-fluid">
    ...
    <div class="row-button">  
      <a href="${pageContext.request.contextPath}/html/about.jsp">
